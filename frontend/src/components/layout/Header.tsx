    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass-dark border-b border-dark-700/50">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-8">
          ...
          <Link href="/voiture" className="text-gray-300 hover:text-premium-orange transition-colors font-medium">
            Voiture
          </Link>
        </nav>
      ...
      {isMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-dark-900/95 backdrop-blur-xl border-b border-dark-700">
          <div className="container mx-auto px-4 py-6 space-y-4">
            ...
            <Link href="/voiture" className="block text-gray-300 hover:text-premium-orange py-2">
              Voiture
            </Link>
